...
describe('GET/todos/:id', () => {
  ...
  it('sould not return todo doc created by other user', (done) => {
    request(app)
...
describe('PATCH/todos/:id', () => {
  ...
  it('should not update todo that is not theirs', (done) => {
    var hexId = todos[0]._id.toHexString();
    var text = 'patch test';
    var completed = true;
...
describe('POST/users/login', () => {
  ...
  it('should reject invalid login', (done) => {
    ...
    .send({
      email: users[1].email,
      password: users[1].password + 'jordan'
    })
    .expect(400)
    .expect((res) => {
